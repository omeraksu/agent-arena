...
Agent Arena, 7 Mart 2026'da Mersin'de 24 lise ve ortaokul öğrencisiyle (11–17 yaş) Avalanche Fuji Testnet üzerinde 3 saatlik uygulamalı bir blockchain workshop'u gerçekleştirdi. Katılımcılar gasless transaction altyapısı sayesinde hiçbir teknik engel olmadan cüzdan oluşturdu, AVAX transferi yaptı ve AI agent etkileşimiyle NFT mint etti. Workshop %75 tam tamamlama oranıyla (sektör ortalaması %40–50) başarılı bir pilot oldu.
...
| | |
|---|---|
| **Etkinlik** | Agent Arena Blockchain Workshop |
| **Tarih** | 7 Mart 2026 |
| **Yer** | Güney Gelişim Koleji, Mersin |
...
Agent Arena, blockchain eğitimindeki en büyük bariyerleri ortadan kaldıran bir workshop platformudur:
...
*Bu rapor Agent Arena v0.1 Mersin Workshop verileri ve platform metrikleri baz alınarak hazırlanmıştır.*
